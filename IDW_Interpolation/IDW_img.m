...
for j = 1:newWidth         % 对图像进行按列逐元素扫描
    ...
    for i = 1:newHeight
        ...
        elseif d+c<=epsilon
            ...
            w11 = 1/sqrt(a+b); % (u1,v1)到左上角(u,v)的距离的倒数
            w12 = 1/sqrt(b+c); % (u1,v1)到右上角(u+1,v)的距离的倒数
            w21 = 1/sqrt(a+d); % (u1,v1)到左下角(u,v+1)的距离的倒数
            w22 = 1/sqrt(c+d); % (u1,v1)到右下角(u+1,v+1)的距离的倒数
            D = w11+w12+w21+w22;  % 距离倒数之和
